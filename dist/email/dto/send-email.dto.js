...
__decorate([
    (0, class_validator_1.IsEmail)({}, { message: 'Receiver email must be valid' }),
    __metadata("design:type", String)
], SendEmailDto.prototype, "to", void 0);
__decorate([
    (0, class_validator_1.IsString)({ message: "Subject should be any text" }),
...
__decorate([
    ...
    (0, class_validator_1.MaxLength)(5000, { message: " Max length should exceed the 5000" }),
    __metadata("design:type", String)
